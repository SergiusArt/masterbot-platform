    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        try:
            ...
            return DashboardSummary(
                ...
                bablo=BabloStats(
                    today_count=bablo_data.get("total_signals", 0),
                    long_count=bablo_data.get("long_count", 0),
                    short_count=bablo_data.get("short_count", 0),
                    avg_quality=bablo_data.get("average_quality", 0),
